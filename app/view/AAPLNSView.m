...
- (BOOL)setupCVDisplayLinkForScreen:(NSScreen*)screen {
    ...
    cvReturn = CVDisplayLinkSetOutputCallback(_displayLink, &DispatchRenderLoop,
...
static CVReturn DispatchRenderLoop(CVDisplayLinkRef displayLink, const CVTimeStamp* now,
